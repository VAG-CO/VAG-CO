...
class PPOSampler(BaseRNNSampler):
    ...
    def sparse_reduced_Nb_Hb_loss(self, params, Sb_Hb_H_graph, Sb_minibatch_compl_graph, Nb_ext_fields, c1 = 0.5):
        ...
        Nb_minibatch_Values, curr_Nb_minibatch_log_probs = self.vmapped_eval_apply(params, Sb_Hb_H_graph, Sb_minibatch_compl_graph, Nb_ext_fields, Nb_minibatch_actions)
    ...
    def init_vmapped_eval(self):
        self.vmapped_eval_apply = jax.jit(jax.vmap(self.eval_spin, in_axes=(None, None, None, 0, 0), out_axes=(0,0)))
    ...
    def backward_sparse_reduced_Nb_Hb_loss(self, params, opt_state, Sb_minibatch_H_graph, Sb_minibatch_compl_graph, Nb_ext_fields):
        (overall_loss, (actor_loss, critic_loss)), grad = self.sparse_reduced_Nb_Hb_backward_func(params, Sb_minibatch_H_graph, Sb_minibatch_compl_graph, Nb_ext_fields)

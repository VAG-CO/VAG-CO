...
import jraph
from Networks.BuildingBlocks.GNNetworks import ResidualNonlinearMessageLayer, FlaxMLP, MPNN_simple, MPNN, GIN, GIN_skip
import jax
...
class EncodeProcess_node_embedding(nn.Module):
    ...
    def setup(self):
        ...
        self.embedding_GNN_layer = Graph_func(self.encode_edge_features, self.encode_node_features,
                                              self.encode_edge_features
                                              , layer_norm=self.layer_norm, edgeMLP=self.edge_updates,

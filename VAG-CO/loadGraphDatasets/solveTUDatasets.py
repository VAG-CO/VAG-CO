...
from GreedyAlgorithms import GreedyMIS, GreedyMaxCut
from tqdm import tqdm
from loadGraphDatasets.loadTwitterGraph import TWITTER
from utils import sympy_utils
...
def solve_greedy(parent = True):
    ...
    dataset_names = ["COLLAB","ENZYMES", "PROTEINS", "IMDB-BINARY", "MUTAG"]
    ...
    for dataset_name in dataset_names:
        ...
        for EnergyFunction in EnergyFunctions:
            for seed in seeds:
                for mode in modes:
                    mean_AR = GreedySolve( dataset_name=dataset_name, mode=mode, EnergyFunction=EnergyFunction,
